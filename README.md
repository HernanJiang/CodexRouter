...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.7.6-0969da" alt="Version 1.7.6">
...
Download the Windows x64 package from [GitHub Releases](https://github.com/HernanJiang/CodexRouter/releases/tag/v1.7.6):

`Codex-Router-Portable-1.7.6-windows-x64.zip`

An optional per-user installer is also provided as `Codex-Router-Installer-1.7.6-windows-x64.exe`. It opens a setup wizard so you can choose the install location, keep a desktop shortcut by default, and confirm before installation starts. The default location is `%LOCALAPPDATA%\Programs\CodexRouter\1.7.6`. No administrator access is required.
