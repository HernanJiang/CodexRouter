...
<p align="center">
  <img src="https://img.shields.io/badge/version-2.0.8-0969da" alt="版本 2.0.8">
...
前往 [GitHub Releases](https://github.com/HernanJiang/CodexRouter/releases/tag/v2.0.8) 下载 Windows x64 版本：

`Codex-Router-Portable-2.0.8-windows-x64.zip`

同时提供可选的用户级安装器：`Codex-Router-Setup-2.0.8.exe`。安装时会打开向导，由你选择安装位置、默认创建桌面快捷方式，并在确认后再开始安装。默认路径为 `%LOCALAPPDATA%\Programs\CodexRouter\2.0.8`，不需要管理员权限。
