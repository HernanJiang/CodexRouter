...
Each third-party component remains governed by its respective license and notices (see THIRD_PARTY_NOTICES.md). Where AGPL-3.0 applies to the combined distribution, it applies to original Codex-Router material; third-party components continue under their own upstream licenses. Do not remove third-party notices or claim third-party code as your own.
