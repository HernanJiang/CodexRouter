...
Codex-Router may not be used for unlawful activity, unauthorized access, credential theft, malware, data abuse, attacks, security-control circumvention, or infringement. You may not add advertising, backdoors, telemetry, mining, malicious updates, credential collection, or remote-control behavior and distribute the result. Terms, attribution, origin, integrity, and security notices may not be bypassed or removed. Users are responsible for protecting API keys, OAuth credentials, databases, and configuration.

## 7. Sub2API commitment

Sub2API is an independent third-party open-source project licensed under LGPL-3.0-or-later and subject to its upstream deployment and operations commitment. These terms do not claim ownership of Sub2API or restrict rights granted by its upstream license. When using the bundled integration, you must have lawful authorization for all accounts, APIs, and data and may use it only locally for personal, non-commercial purposes under this Codex-Router distribution. You may not provide paid relaying, quota distribution, shared subscriptions, payment services, account rental, or a public API under the Codex-Router name. You may not evade or help others evade regional, account, identity, risk-control, billing, access, or usage restrictions imposed by OpenAI, Anthropic, Google, or another upstream provider. You remain independently responsible for applicable law, provider terms, acceptable-use policies, privacy, data protection, configuration, operation, promotion, payments, users, content, data, accounts, and API calls. You may not imply that Codex-Router, Sub2API, or their authors authorize, endorse, guarantee, or jointly operate a third-party service.
...
Each third-party component remains governed by its respective license. Do not remove third-party notices or claim third-party code as your own or as Codex-Router original material. If these terms conflict with a third-party license, that license controls only for the relevant third-party component; original Codex-Router material remains governed by these terms and the proprietary license.
