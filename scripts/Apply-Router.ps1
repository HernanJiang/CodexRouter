...
$defaultModel = Get-RouterDefaultPublicModelId -RouterConfig $config -RoutePlan $routePlan
# The model catalog is generated by the Rust GUI before Apply-Router runs.
if (-not (Test-Path -LiteralPath $catalogPath -PathType Leaf)) {
    throw "Model catalog not found at $catalogPath. Apply must be triggered from the Codex-Router GUI."
}
