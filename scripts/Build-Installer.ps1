...
$sedPath = Join-Path $work 'Codex-Router-1.5.4.sed'
try {
...
%FILE1%=
[Strings]
InstallPrompt="Install Codex-Router 1.5.4 for the current Windows user."
DisplayLicense=""
FinishMessage="Codex-Router 1.5.4 was installed. Your existing user data was preserved."
FriendlyName="Codex-Router 1.5.4"
